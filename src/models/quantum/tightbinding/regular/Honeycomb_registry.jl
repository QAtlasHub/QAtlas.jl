# models/quantum/tightbinding/regular/Honeycomb_registry.jl
#
# Declarative implementation map for the regular honeycomb tight-binding
...
@register(
    ...
    reliability=:high,
    tested_in="test/models/quantum/tightbinding/test_honeycomb_tb_scalar_invariants.jl",
