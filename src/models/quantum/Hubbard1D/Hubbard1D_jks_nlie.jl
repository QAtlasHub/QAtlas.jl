...
Internal submodule implementing the Juttner-Klumper-Suzuki (JKS, 1998)
quantum transfer matrix nonlinear integral equations for the 1D Hubbard
chain at finite temperature.

Public entry is wired through fetch(::Hubbard1D, ::FreeEnergy, ::Infinite).
The submodule exported helpers atomic_free_energy and
