...
| [`EnergyLocal`](@ref)                     | ✅                 | —                  | —                                         |
| [`LocalMagnetization`](@ref)`(:x)`        | ✅                 | —                  | —                                         |
| [`QuenchLocalMagnetization`](@ref)`(:x)`  | ✅                 | —                  | ✅ closed-form k-integral (#145)          |
| [`LocalMagnetization`](@ref)`(:z)`        | ✅                 | —                  | —                                         |
...
In the [Verified Atlas](../../atlas/index.md), this model registers 67 hubs (quantity / BC pair). The badge column shows the R1 assurance level; click a hub link to see the exact `verify(...)` calls, references, and corroboration mechanism.
...
| [`SurfaceMagnetization`](../../atlas/hubs/TFIM_SurfaceMagnetization_OBC.md) | `OBC` | 🟢 corroborated-at-p | 1 |
