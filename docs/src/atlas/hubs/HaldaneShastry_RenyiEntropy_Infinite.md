# 🟠 `HaldaneShastry/RenyiEntropy/Infinite`
...
- Delegates to Universality(:Heisenberg) with c -> c*(1+1/alpha)/2 substitution. Reduces to VN at alpha=1.
...
[← Model: `HaldaneShastry`](../models/HaldaneShastry.md) · [Quantity: `RenyiEntropy`](../quantities/RenyiEntropy.md) · [Atlas index](../index.md)
