...
```@autodocs
Modules = [QAtlas]
Pages = ["models/quantum/KitaevHeisenberg/KitaevHeisenberg.jl", "models/quantum/KitaevHeisenberg/KitaevHeisenberg_registry.jl", "models/quantum/KitaevHoneycomb/KitaevHoneycomb.jl", "models/quantum/KitaevHoneycomb/KitaevHoneycomb_registry.jl", "models/quantum/KitaevHoneycomb/KitaevHoneycomb_thermal.jl"]
Private = false
Order = [:type, :function]
```
