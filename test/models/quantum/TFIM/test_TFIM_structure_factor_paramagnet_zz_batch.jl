# ─────────────────────────────────────────────────────────────────────────────
# test/models/quantum/TFIM/test_TFIM_structure_factor_paramagnet_zz_batch.jl
#
# ZZ axis split of the original test_TFIM_structure_factor_paramagnet_batch.jl
...
# maximally mixed state ρ = I / 2^N, so ⟨σ^zz_i σ^zz_j⟩
# = δ_ij and S_zzzz(q) = 1 for all q, all BC.
#
...
@testset "TFIM — ZZStructureFactor at T→∞ paramagnet = 1 (#381 batch, part 1/4)" begin
    HIGH_T_BETA = 1e-3
