...
|---|---|---|---|---|
| `@sweep` | `ed_finite_size` | 🟢 structural | Kasteleyn 1961: KTF Pfaffian count vs brute-force perfect-matching enumeration | `test/models/classical/test_dimer_lattice.jl` |
| `@sweep` | `ed_finite_size` | 🟢 structural | Kasteleyn 1961: KTF Pfaffian count vs brute-force perfect-matching enumeration | `test/models/classical/test_dimer_lattice.jl` |
| `@sweep` | `ed_finite_size` | 🟢 structural | Kasteleyn 1961: KTF Pfaffian count vs brute-force perfect-matching enumeration | `test/models/classical/test_dimer_lattice.jl` |
| `@sweep` | `ed_finite_size` | 🟢 structural | Kasteleyn 1961: KTF Pfaffian count vs brute-force perfect-matching enumeration | `test/models/classical/test_dimer_lattice.jl` |
| `@sweep` | `ed_finite_size` | 🟢 structural | Kasteleyn 1961: KTF Pfaffian count vs brute-force perfect-matching enumeration | `test/models/classical/test_dimer_lattice.jl` |
...
[← Model: `DimerLattice`](../models/DimerLattice.md) · [Quantity: `PartitionFunction`](../quantities/PartitionFunction.md) · [Atlas index](../index.md)
