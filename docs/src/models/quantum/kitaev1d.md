...
| [`MassGap`](../../atlas/hubs/Kitaev1D_MassGap_OBC.md) | `OBC` | 🟢 corroborated-at-p | 5 |
...
| [`UniversalityClass`](../../atlas/hubs/Kitaev1D_UniversalityClass_Infinite.md) | `Infinite` | 🟠 uncorroborated-but-feasible | 0 |
...
```@autodocs
Modules = [QAtlas]
Pages = ["models/quantum/Kitaev1D/Kitaev1D.jl", "models/quantum/Kitaev1D/Kitaev1D_registry.jl", "models/quantum/Kitaev1D/Kitaev1D_thermal.jl"]
Private = false
Order = [:type, :function]
```
