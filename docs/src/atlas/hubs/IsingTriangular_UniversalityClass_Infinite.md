# 🟠 `IsingTriangular/UniversalityClass/Infinite`
...
- Emergent universality class: :Ising
...
[← Model: `IsingTriangular`](../models/IsingTriangular.md) · [Quantity: `UniversalityClass`](../quantities/UniversalityClass.md) · [Atlas index](../index.md)
