# 🟠 `TFIM/LightconeSpinCorrelation/OBC`
...
- C(r,t) lightcone slice for fixed center; takes a `times` vector.
...
[← Model: `TFIM`](../models/TFIM.md) · [Quantity: `LightconeSpinCorrelation`](../quantities/LightconeSpinCorrelation.md) · [Atlas index](../index.md)
