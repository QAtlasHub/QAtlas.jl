# 🟠 `IsingTriangular/ThermalEntropy/Infinite`
...
- FM (J<0): s = β(ε-f); bounded 0 (T→0) … ln2 (T→∞).
...
[← Model: `IsingTriangular`](../models/IsingTriangular.md) · [Quantity: `ThermalEntropy`](../quantities/ThermalEntropy.md) · [Atlas index](../index.md)
