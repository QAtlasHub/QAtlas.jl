# 🟠 `DimerLattice/FreeEnergy/Infinite`
...
- Free-energy density per site f = −s = −G/π (unit weights ⇒ zero internal energy).
...
[← Model: `DimerLattice`](../models/DimerLattice.md) · [Quantity: `FreeEnergy`](../quantities/FreeEnergy.md) · [Atlas index](../index.md)
