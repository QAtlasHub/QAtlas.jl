# 🟠 `DimerLattice/ResidualEntropy/Infinite`
...
- method `analytic`, status `exact`, reliability `high`, refs: Fisher1961
- Entropy per site s = lim (ln Z)/N = G/π ≈ 0.29156 (Catalan/π); per dimer 2G/π.
...
[← Model: `DimerLattice`](../models/DimerLattice.md) · [Quantity: `ResidualEntropy`](../quantities/ResidualEntropy.md) · [Atlas index](../index.md)
