...
!!! info "Assurance taxonomy (R1, ratified — Discussion #379)"
    ...
    - 🔵 **coherent** — an independent in-repo card exists and the value satisfies an internal invariant (sum rule / limiting case / delegation), but no external value re-derives it.
