# 🟠 `TASEP/UniversalityClass/Infinite`
...
- Emergent universality class: :KPZ
...
[← Model: `TASEP`](../models/TASEP.md) · [Quantity: `UniversalityClass`](../quantities/UniversalityClass.md) · [Atlas index](../index.md)
