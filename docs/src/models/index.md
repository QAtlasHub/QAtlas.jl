...
All **62 models** with registered `@register` entries, derived from `src/*_registry.jl`.  Run `julia docs/atlas/generate.jl` to refresh.

**Assurance:** 🟣 universality-corroborated · 🟢 corroborated-at-p · 🔵 coherent · ⚪ cited-only · 🟠 uncorroborated-but-feasible
