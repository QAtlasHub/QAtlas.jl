...
|---|---|---|---|
| [`Energy`](../../atlas/hubs/SixVertex_Energy_Infinite.md) | `Infinite` | 🟠 uncorroborated-but-feasible | 0 |
...
```@autodocs
Modules = [QAtlas]
Pages = ["models/classical/SixVertex/SixVertex.jl", "models/classical/SixVertex/SixVertex_registry.jl"]
Private = false
Order = [:type, :function]
```
