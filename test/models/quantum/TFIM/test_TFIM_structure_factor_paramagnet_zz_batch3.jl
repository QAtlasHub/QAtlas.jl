# ─────────────────────────────────────────────────────────────────────────────
# test/models/quantum/TFIM/test_TFIM_structure_factor_paramagnet_zz_batch3.jl
#
# Part 3/4 of the ZZ-axis paramagnet structure-factor batch (one (J, h) pair
...
@testset "TFIM — ZZStructureFactor at T→∞ paramagnet = 1 (#381 batch, part 3/4)" begin
    HIGH_T_BETA = 1e-3
