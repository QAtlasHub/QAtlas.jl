...
In this page, all model list defined in QAtlas.jl is shown. **64 models** have `@register` entries, derived from `src/*_registry.jl`.
...
| [`Bound`](../atlas/models/Bound.md) | 4 | 🟣 0 🟢 0 🔵 0 ⚪ 0 🟠 4 | — |
