# ─────────────────────────────────────────────────────────────────────────────
# test/models/quantum/TFIM/test_TFIM_structure_factor_paramagnet_yy_batch4.jl
#
# Part 4/4 of the YY-axis paramagnet structure-factor batch (one (J, h) pair
...
@testset "TFIM — YYStructureFactor at T→∞ paramagnet = 1 (#381 batch, part 4/4)" begin
    HIGH_T_BETA = 1e-3
