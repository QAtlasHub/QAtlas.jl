...
- method `analytic`, status `bound`, reliability `high`, refs: MaldacenaShenkerStanford2016
- MSS 2016 chaos bound: Lyapunov λ_L ≤ 2π/β, saturated by holographic / large-N SYK.
...
[← Model: `Bound`](../models/Bound.md) · [Quantity: `ChaosBound`](../quantities/ChaosBound.md) · [Atlas index](../index.md)
