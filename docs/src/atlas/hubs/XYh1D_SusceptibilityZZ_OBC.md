...
- transverse susceptibility per site from exact Wick contraction over covariance.
...
[← Model: `XYh1D`](../models/XYh1D.md) · [Quantity: `SusceptibilityZZ`](../quantities/SusceptibilityZZ.md) · [Atlas index](../index.md)
