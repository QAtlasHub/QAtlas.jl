# 🟠 `Kitaev1D/ThermalEntropy/Infinite`
...
- s(β) = β(ε-f); bounded 0 (T→0) … ln2 (T→∞, two states per spinless mode).
...
[← Model: `Kitaev1D`](../models/Kitaev1D.md) · [Quantity: `ThermalEntropy`](../quantities/ThermalEntropy.md) · [Atlas index](../index.md)
