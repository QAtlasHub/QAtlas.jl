# 🟠 `IsingTriangular/FreeEnergy/Infinite`
...
- FM (J<0): -βf = ln2 + (1/8π²)∫∫ ln[cosh³2K+sinh³2K-sinh2K(cosθ+cosφ+cos(θ+φ))], K=β|J|.
...
[← Model: `IsingTriangular`](../models/IsingTriangular.md) · [Quantity: `FreeEnergy`](../quantities/FreeEnergy.md) · [Atlas index](../index.md)
