...
- c_v(beta) = 1/pi \int_0^pi (beta\lambda/2)^2 sech^2(beta\lambda/2) dk; QuadGK rtol=1e-10.
...
[← Model: `SSH`](../models/SSH.md) · [Quantity: `SpecificHeat`](../quantities/SpecificHeat.md) · [Atlas index](../index.md)
