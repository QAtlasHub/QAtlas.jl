# 🟠 `TFIM/UniversalityClass/Infinite`
...
- Emergent universality class: :Ising (clean TFIM), :IsingSDRG (IRFP / random-bond limit)
...
[← Model: `TFIM`](../models/TFIM.md) · [Quantity: `UniversalityClass`](../quantities/UniversalityClass.md) · [Atlas index](../index.md)
