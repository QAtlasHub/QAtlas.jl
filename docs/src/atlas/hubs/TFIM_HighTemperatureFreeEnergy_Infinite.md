# 🟠 `TFIM/HighTemperatureFreeEnergy/Infinite`
...
- method `analytic`, status `approx`, reliability `high`, refs: Pfeuty1970
- f/N ≈ -ln2/β - (β/2)(J²+h²) + O(β³), valid for βJ ≪ 1.
...
[← Model: `TFIM`](../models/TFIM.md) · [Quantity: `HighTemperatureFreeEnergy`](../quantities/HighTemperatureFreeEnergy.md) · [Atlas index](../index.md)
