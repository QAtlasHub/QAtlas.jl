# 🟠 `Bound/BekensteinBound/Infinite`
...
- method `analytic`, status `bound`, reliability `high`, refs: Bekenstein1981
- Bekenstein 1981 entropy bound: S ≤ 2π R E, saturated (up to O(1)) by black holes.
...
[← Model: `Bound`](../models/Bound.md) · [Quantity: `BekensteinBound`](../quantities/BekensteinBound.md) · [Atlas index](../index.md)
