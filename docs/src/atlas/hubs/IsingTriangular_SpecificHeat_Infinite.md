# 🟠 `IsingTriangular/SpecificHeat/Infinite`
...
- method `analytic`, status `exact`, reliability `high`, refs: Houtappel1950
- FM (J<0): c_v = β²∂²(logZ/N)/∂β²; singular at T_c=4|J|/ln3 (2D-Ising universality).
...
[← Model: `IsingTriangular`](../models/IsingTriangular.md) · [Quantity: `SpecificHeat`](../quantities/SpecificHeat.md) · [Atlas index](../index.md)
