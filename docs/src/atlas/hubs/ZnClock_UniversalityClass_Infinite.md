# 🟠 `ZnClock/UniversalityClass/Infinite`
...
- Emergent universality class: :Ising, :Potts3
...
[← Model: `ZnClock`](../models/ZnClock.md) · [Quantity: `UniversalityClass`](../quantities/UniversalityClass.md) · [Atlas index](../index.md)
