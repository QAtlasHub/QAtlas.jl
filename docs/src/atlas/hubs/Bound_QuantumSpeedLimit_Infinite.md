# 🟠 `Bound/QuantumSpeedLimit/Infinite`
...
- method `analytic`, status `bound`, reliability `high`, refs: MargolusLevitin1998
- Margolus-Levitin 1998 quantum speed limit: orthogonalization time τ ≥ π/(2E).
...
[← Model: `Bound`](../models/Bound.md) · [Quantity: `QuantumSpeedLimit`](../quantities/QuantumSpeedLimit.md) · [Atlas index](../index.md)
