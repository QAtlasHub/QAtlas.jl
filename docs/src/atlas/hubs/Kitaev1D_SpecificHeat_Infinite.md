# 🟠 `Kitaev1D/SpecificHeat/Infinite`
...
- c_v = β²Var(H)/L = (β²/8π)∫E²sech²(βE/2)dk (free-fermion energy FDT).
...
[← Model: `Kitaev1D`](../models/Kitaev1D.md) · [Quantity: `SpecificHeat`](../quantities/SpecificHeat.md) · [Atlas index](../index.md)
