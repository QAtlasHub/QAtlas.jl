# 🟠 `IsingTriangular/Energy/Infinite`
...
- FM (J<0): ε = -∂(logZ/N)/∂β (central diff of Houtappel f); ε → -3|J| at T→0.
...
[← Model: `IsingTriangular`](../models/IsingTriangular.md) · [Quantity: `Energy`](../quantities/Energy.md) · [Atlas index](../index.md)
