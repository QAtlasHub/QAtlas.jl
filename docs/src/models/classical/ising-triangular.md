...
In the [Verified Atlas](../../atlas/index.md), this model registers 8 hubs (quantity / BC pair). The badge column shows the R1 assurance level; click a hub link to see the exact `verify(...)` calls, references, and corroboration mechanism.
