...
- method `analytic`, status `exact`, reliability `high`, refs: SSH1979 | SSH1980
- s(beta) = 1/pi \int_0^pi [ log(1+e^{-beta\lambda}) + beta\lambda n_F(beta\lambda) ] dk; High-T limit log 2 per site.
...
[← Model: `SSH`](../models/SSH.md) · [Quantity: `ThermalEntropy`](../quantities/ThermalEntropy.md) · [Atlas index](../index.md)
