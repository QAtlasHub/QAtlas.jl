...
- method `cft`, status `approx`, reliability `high`, refs: Cardy1986
- Conformal tower of states excitation spectrum E_n - E_0 = (2π v / L) Δ_n scaled by CFT sound velocity v = 2J.
...
[← Model: `TFIM`](../models/TFIM.md) · [Quantity: `ConformalTower`](../quantities/ConformalTower.md) · [Atlas index](../index.md)
