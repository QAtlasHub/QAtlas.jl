# 🟠 `DimerLattice/UniversalityClass/Infinite`
...
- Emergent universality class: :XY
...
[← Model: `DimerLattice`](../models/DimerLattice.md) · [Quantity: `UniversalityClass`](../quantities/UniversalityClass.md) · [Atlas index](../index.md)
