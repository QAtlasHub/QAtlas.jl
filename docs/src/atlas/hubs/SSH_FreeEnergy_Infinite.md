...
- f(beta) = -1/(2pi beta) \int_0^pi log(2 cosh(beta \lambda(k)/2)) dk; QuadGK rtol=1e-10.
...
[← Model: `SSH`](../models/SSH.md) · [Quantity: `FreeEnergy`](../quantities/FreeEnergy.md) · [Atlas index](../index.md)
