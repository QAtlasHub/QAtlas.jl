# 🟠 `HaldaneShastry/SpecificHeat/Infinite`
...
- method `cft_low_T`, status `approx`, reliability `medium`, refs: Haldane1988 | Affleck1986
- c_v = π T / (3 v_s) = 2T / (3J). Equals s at LO CFT. Valid β > 5/J.
...
[← Model: `HaldaneShastry`](../models/HaldaneShastry.md) · [Quantity: `SpecificHeat`](../quantities/SpecificHeat.md) · [Atlas index](../index.md)
