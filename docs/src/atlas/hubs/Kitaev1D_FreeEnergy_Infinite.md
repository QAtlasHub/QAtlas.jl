...
- BdG f(β) = -(1/2π)∫[E/2 + β⁻¹ln(1+e^{-βE})]dk over the PBC dispersion; β→∞ → ε₀.
...
[← Model: `Kitaev1D`](../models/Kitaev1D.md) · [Quantity: `FreeEnergy`](../quantities/FreeEnergy.md) · [Atlas index](../index.md)
