using Test
using QAtlas
using QAtlas: Heisenberg1D, VonNeumannEntropy, RenyiEntropy, Universality, Infinite

@testset "Heisenberg1D Infinite VN/Renyi delegation to Universality(:Heisenberg) (#580 Phase 1)" begin
    m = Heisenberg1D()
