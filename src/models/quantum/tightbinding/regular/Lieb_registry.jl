# models/quantum/tightbinding/regular/Lieb_registry.jl
#
# Declarative implementation map for the regular lieb tight-binding
...
@register(
    ...
    reliability=:high,
    tested_in="test/models/quantum/tightbinding/test_lieb_tb_scalar_invariants.jl",
