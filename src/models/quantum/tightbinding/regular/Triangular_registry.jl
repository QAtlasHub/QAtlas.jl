# models/quantum/tightbinding/regular/Triangular_registry.jl
#
# Declarative implementation map for the regular triangular tight-binding
...
@register(
    ...
    reliability=:high,
    tested_in="test/models/quantum/tightbinding/test_triangular_tb_scalar_invariants.jl",
