...
@register(
    ...
    tested_in="test/identities/test_driven_free_fermion_nonlinear_response.jl",
    references=["DunlapKenkre1986", "HolthausHone1996"],
    notes="AC-driven free-fermion (V=0) higher-order response: peak n-th harmonic " *
          "current amplitude Aₙ = 2t|J₀| (n=0) / 4t|Jₙ(E₀/ω)| (n≥1); leading small-field " *
          "χ⁽ⁿ⁾ = 4t/(n!(2ω)ⁿ) via nonlinear_susceptibility. V≠0 deferred to Phase 2.",
)
