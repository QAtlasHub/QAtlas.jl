...
| | count |
|---|---|
| Hubs `src` claims (registry) | 314 |
| ED-feasible claimed (risk denominator) | 288 |
...
**Externally-corroborated rate** (🟣+🟢 over ED-feasible claimed): **61.8%** · **in-repo-verified rate** (incl. 🔵 coherent): **75.3%**
