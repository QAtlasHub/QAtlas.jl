...
| Inventory cards scanned (whole test/) | 2801 |
| Registry files parsed | 74 / 74 |
| Models | 66 |

**Externally-corroborated rate** (🟣+🟢 over ED-feasible claimed): **55.0%** · **in-repo-verified rate** (incl. 🔵 coherent): **66.6%**
...
| `SixVertex` | 4 | 0 | 1 | 1 | 0 | 2 | feasible |
