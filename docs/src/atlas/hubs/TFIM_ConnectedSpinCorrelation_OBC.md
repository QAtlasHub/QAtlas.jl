# 🟠 `TFIM/ConnectedSpinCorrelation/OBC`
...
- Connected = static for TFIM by Z₂ symmetry; explicit method for clarity.
...
[← Model: `TFIM`](../models/TFIM.md) · [Quantity: `ConnectedSpinCorrelation`](../quantities/ConnectedSpinCorrelation.md) · [Atlas index](../index.md)
