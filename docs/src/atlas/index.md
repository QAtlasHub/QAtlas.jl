...
| | count |
|---|---|
| Hubs `src` claims (registry) | 369 |
| ED-feasible claimed (risk denominator) | 343 |
...
**Externally-corroborated rate** (🟣+🟢 over ED-feasible claimed): **55.1%** · **in-repo-verified rate** (incl. 🔵 coherent): **66.5%**
