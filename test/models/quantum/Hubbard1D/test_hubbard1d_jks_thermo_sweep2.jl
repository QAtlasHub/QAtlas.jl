# test/models/quantum/Hubbard1D/test_hubbard1d_jks_thermo_sweep2.jl
#
# Part 2/2 of the JKS NLIE FreeEnergy@Infinite benchmark (#523): the
# cross-validation half (U-dependence, grid refinement, thermodynamic
# consistency, atomic ED comparison, low-T Lieb-Wu check). Split off
# test_hubbard1d_jks_thermo_sweep.jl so CI can run the two halves on
# separate shards.
...
@testset "Hubbard1D JKS NLIE — cross-validation (#523, part 2/2)" begin
