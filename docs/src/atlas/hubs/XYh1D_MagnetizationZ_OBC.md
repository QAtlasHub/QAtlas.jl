...
- transverse magnetization per site from the thermal Majorana covariance matrix.
...
[← Model: `XYh1D`](../models/XYh1D.md) · [Quantity: `MagnetizationZ`](../quantities/MagnetizationZ.md) · [Atlas index](../index.md)
