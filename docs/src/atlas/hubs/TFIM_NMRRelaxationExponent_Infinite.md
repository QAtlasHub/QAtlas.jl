# 🟠 `TFIM/NMRRelaxationExponent/Infinite`
...
- method `analytic`, status `exact`, reliability `high`, refs: Sachdev1997
- θ_NMR = -3/4 = -0.75 at the quantum critical point h = J.
...
[← Model: `TFIM`](../models/TFIM.md) · [Quantity: `NMRRelaxationExponent`](../quantities/NMRRelaxationExponent.md) · [Atlas index](../index.md)
