...
| | count |
|---|---|
| Hubs `src` claims (registry) | 373 |
| ED-feasible claimed (risk denominator) | 347 |
...
**Externally-corroborated rate** (🟣+🟢 over ED-feasible claimed): **53.9%** · **in-repo-verified rate** (incl. 🔵 coherent): **65.1%**
