...
@register(
    ...
    reliability=:high,
    tested_in=[
        "test/models/quantum/misc/test_aklt2d.jl",
        "test/models/quantum/misc/test_aklt_htse.jl",
        "test/models/quantum/misc/test_aklt_structural.jl",
        "test/models/quantum/misc/test_aklt_thermal_limits.jl",
        "test/models/quantum/misc/test_aklt_verify_closed_form.jl",
        "test/models/quantum/misc/test_aklt_verify_main.jl",
    ],
    references=["AKLT1988"],
