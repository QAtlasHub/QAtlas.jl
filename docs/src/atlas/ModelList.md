...
| [`Heisenberg1D`](models/Heisenberg1D.md) | — | 26 | `analytic`, `bethe_ansatz`, `cft_low_T`, `closed_form`, `delegation`, `dense_ed`, `muller_ansatz` | 0 | 13 | 4 | 0 | 9 | feasible | `@su2` |
...
| [`TFIM`](models/TFIM.md) | `Ising` | 54 | `analytic`, `bdg`, `cft`, `delegation`, `pfaffian` | 0 | 36 | 9 | 0 | 9 | feasible | `@critical`, `@disordered`, `@ordered` |
...
- [`CorrelationLength`](quantities/CorrelationLength.md) — 5 models
...
- [`FreeEnergy`](quantities/FreeEnergy.md) — 14 models
...
- [`ThermalEntropy`](quantities/ThermalEntropy.md) — 12 models
