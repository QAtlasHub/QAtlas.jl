# 🟠 `SixVertex/UniversalityClass/Infinite`
...
[← Model: `SixVertex`](../models/SixVertex.md) · [Quantity: `UniversalityClass`](../quantities/UniversalityClass.md) · [Atlas index](../index.md)
