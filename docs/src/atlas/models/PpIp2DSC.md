...
2-D p_x + i p_y chiral superconductor (Read–Green 2000) for spinless fermions, with BCS pairing amplitude `Δ₀ > 0` and chemical potential `μ > 0` (weak-pairing topological phase).
